...
<div class="card" style="max-width: 600px;">
    <div class="card-body">
        <form method="POST" action="<?= base_url('users/edit.php?id=' . $id) ?>" enctype="multipart/form-data">
            ...
            <div style="text-align: center; margin-bottom: 2rem;">
                ...
                ?>
                <img src="<?= $currentPhoto ?>" alt="<?= htmlspecialchars($user['nama']) ?>" class="avatar avatar-lg"
