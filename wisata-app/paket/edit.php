...
if ($id === false) {
    setFlash('danger', 'ID paket tidak valid');
    ...
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control" value="<?= htmlspecialchars($package['nama']) ?>"
                    required>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                <div class="form-group">
                    ...
                    <input type="number" name="harga" class="form-control" value="<?= $package['harga'] ?>" min="0"
                        required>
                </div>
